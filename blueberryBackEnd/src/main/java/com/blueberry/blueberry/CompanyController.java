    ...
    List<Company> getCompanies(){
        if(companyRepository.findAll().size()<6) {
            companyRepository.saveAll(Arrays.asList(
                    ...
                    new Company(null, "Röda Korset", "Götavägen 22, 110 30 Stockholm","Stockholm", new Account(null,"Gunnar Skogqvist","123",Role.COMPANY), "Vi är världens största humanitära nätverk och vi finns i 192 länder. Målet är att förhindra och lindra mänskligt lidande, oavsett vem det drabbar.", new OpeningTimes(LocalTime.of(9,00),LocalTime.of(10, 10),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00)),new ArrayList<BlogPost>()),
                    ...
                    new Company(null, "Rädda barnen", "Gustavslundsvägen 141, 107 88 Stockholm","Stockholm", new Account(null,"Alia Bhatt","123",Role.COMPANY), "Vi finns på plats i Sverige och 119 andra länder och arbetar för alla barns självklara rätt att överleva, utvecklas och växa upp i trygghet. Att rädda barnen är att rädda världen.",new OpeningTimes(LocalTime.of(9,00),LocalTime.of(10, 10),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00)),new ArrayList<BlogPost>()),
                    ...
                    new Company(null, "Geblod", "Norrtullsgatan 6, 6tr, 113 29 Stockholm", "Stockholm",new Account(null,"Jorien ter Mors","123",Role.COMPANY), "I Sverige behövs i snitt en blodpåse i minuten, dygnet runt, året runt. Blodet räddar liv och används till exempel vid cancerbehandlingar, förlossningar, operationer och olyckor. Hjälp oss hjälpa andra!", new OpeningTimes(LocalTime.of(9,00),LocalTime.of(10, 10),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00)),new ArrayList<BlogPost>()),
                    new Company(null, "Cancerfonden", "David Bagares gata 5, 101 55 Stockholm","Stockholm", new Account(null,"Travis Bickle","123",Role.COMPANY), "I Sverige får en av tre ett cancerbesked under sin livstid. För att färre ska drabbas och fler ska överleva finansierar vi den främsta forskningen, sprider kunskap om cancer och påverkar beslutsfattare i viktiga frågor.", new OpeningTimes(LocalTime.of(9,00),LocalTime.of(10, 10),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00)),new ArrayList<BlogPost>()),
                    new Company(null, "Kris", "Gröndalsvägen 194, 117 69 Stockholm", "Stockholm",new Account(null,"Charles Ponzi","123",Role.COMPANY), "Kriminellas Revansch I Samhället, KRIS, är en ideell förening där före detta kriminella och missbrukare hjälper varandra tillbaka in i samhället. Vi har funnits sedan oktober 1997, då var vi 11 medlemmar.", new OpeningTimes(LocalTime.of(9,00),LocalTime.of(10, 10),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00)),new ArrayList<BlogPost>())));
