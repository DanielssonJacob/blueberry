...
public class CompanyController {
    ...
    List<Company> getCompanies() {
        if (companyRepository.findAll().size() < 6) {
            companyRepository.saveAll(Arrays.asList(
                    new Company(null, "UNICEF", "Sankt Eriksgatan 46, 112 34 Stockholm", "Stockholm", new Account(null, "Pernilla Baralt", "123", Role.COMPANY), "UNICEF is working towards all the childrens rights. Over the whole world we are working towards that all children get the right to the childhood they deserve. But we need your help.", new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(20, 00), LocalTime.of(10, 00), LocalTime.of(15, 00), LocalTime.of(10, 00), LocalTime.of(15, 00)), new ArrayList(Arrays.asList(new BlogPost("10.000 doses", "With all the help we have received, we have now been able to ship another 10.000 doses of vaccine to countries in need."), new BlogPost("We need money", "We really appreciate all the help we get. But at the moment, we are unable to make use of all the clothing donations we are receiving and there for ask that if you want to help please consider donating money instead."))),"unnamed.jpg"),
                    new Company(null, "Röda Korset", "Götavägen 22, 110 30 Stockholm", "Stockholm", new Account(null, "Gunnar Skogqvist", "123", Role.COMPANY), "Vi är världens största humanitära nätverk och vi finns i 192 länder. Målet är att förhindra och lindra mänskligt lidande, oavsett vem det drabbar.", new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(10, 10), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00)), new ArrayList<BlogPost>(),"companyImage.png"),
                    new Company(null, "Amnesty International", "Haga Östergata 30, 411 22 Göteborg", "Göteborg", new Account(null, "Ahmed Rakhtun", "123", Role.COMPANY), "Amnesty International är en global organisation som kämpar för alla människors lika värde. Vi arbetar för att mänskliga rättigheter ska gälla alla, nu och i framtiden.",  new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(10, 10), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00)), new ArrayList<BlogPost>(), ""),
                    new Company(null, "Rädda barnen", "Gustavslundsvägen 141, 107 88 Stockholm", "Stockholm", new Account(null, "Alia Bhatt", "123", Role.COMPANY), "Vi finns på plats i Sverige och 119 andra länder och arbetar för alla barns självklara rätt att överleva, utvecklas och växa upp i trygghet. Att rädda barnen är att rädda världen.", new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(10, 10), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00)), new ArrayList<BlogPost>(),"barnen.png"),
                    new Company(null, "WWF", "Ulriksdals Slott, 170 81 Solna", "Solna", new Account(null, "Julia Volkova", "123", Role.COMPANY), "WWF är en helt oberoende och partipolitiskt obunden miljö- och naturvårdsorganisation som bildades 1961.",  new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(10, 10), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00)), new ArrayList<BlogPost>(), ""),
                    new Company(null, "Frälsningsarmen", "Torggatan 1, 441 30 Alingsås", "Alingsås", new Account(null, "Julio Iglesias", "123", Role.COMPANY), "Frälsningsarmén i Sverige finns i cirka 70 städer/kommuner med 113 verksamheter. Det är församlingsverksamhet med gudstjänster och gruppaktiviteter för alla åldrar.", new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(10, 10), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00)), new ArrayList<BlogPost>(), ""),
                    new Company(null, "Movember", "PO Box 68600, London", "London", new Account(null, "Casper Janebrink", "123", Role.COMPANY), "Movember är en gemenskap av rockstjärnor som samlar in pengar, vilket gör skillnad för mental hälsa och självmordsförebyggande, prostatacancer och testikelcancer.", new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(10, 10), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00)), new ArrayList<BlogPost>(),""),
                    new Company(null, "Geblod", "Norrtullsgatan 6, 6tr, 113 29 Stockholm", "Stockholm", new Account(null, "Jorien ter Mors", "123", Role.COMPANY), "I Sverige behövs i snitt en blodpåse i minuten, dygnet runt, året runt. Blodet räddar liv och används till exempel vid cancerbehandlingar, förlossningar, operationer och olyckor. Hjälp oss hjälpa andra!", new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(10, 10), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00)), new ArrayList<BlogPost>(), "GeBlod_LOGOTYP_ROD-RGB.svg"),
                    new Company(null, "Cancerfonden", "David Bagares gata 5, 101 55 Stockholm", "Stockholm", new Account(null, "Travis Bickle", "123", Role.COMPANY), "I Sverige får en av tre ett cancerbesked under sin livstid. För att färre ska drabbas och fler ska överleva finansierar vi den främsta forskningen, sprider kunskap om cancer och påverkar beslutsfattare i viktiga frågor.", new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(10, 10), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00)), new ArrayList<BlogPost>(),"nedladdning.png"),
                    new Company(null, "Kris", "Gröndalsvägen 194, 117 69 Stockholm", "Stockholm", new Account(null, "Charles Ponzi", "123", Role.COMPANY), "Kriminellas Revansch I Samhället, KRIS, är en ideell förening där före detta kriminella och missbrukare hjälper varandra tillbaka in i samhället. Vi har funnits sedan oktober 1997, då var vi 11 medlemmar.", new OpeningTimes(LocalTime.of(9, 00), LocalTime.of(10, 10), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00), LocalTime.of(10, 00)), new ArrayList<BlogPost>(),"cropped-KRIS_LOGOTYPE_2021_FB.png")));
    ...
    Company postCompany(@RequestBody Map<String, Object> companyForm) {
        return companyRepository.save(new Company(null, (String) companyForm.get("cName"), (String) companyForm.get("cAddress"), ((String) companyForm.get("cCity")).trim(), accountRepository.findByUsername(((String) companyForm.get("cPerson"))), (String) companyForm.get("cDescription"), new OpeningTimes(), new ArrayList<BlogPost>(), ""));
    }
    ...
    public String changeImage(@RequestParam("file") MultipartFile file, @PathVariable("id") Long id) throws IOException {
        ...
        File newFile = new File("C:\\Users\\frykj\\Downloads\\blueberry\\blueberryPictureService\\public\\"+ fileName );
