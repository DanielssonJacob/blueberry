    ...
    List<Company> getCompanies(){
        if(companyRepository.findAll().size()<6) {
            companyRepository.saveAll(Arrays.asList(
                    new Company(null, "UNICEF", "Sankt Eriksgatan 46, 112 34 Stockholm","Stockholm", new Account(null,"Pernilla Baralt","123",Role.COMPANY), "UNICEF arbetar för alla barns rättigheter. Över hela världen kämpar vi för att alla barn ska få den barndom som de har rätt till. Men vi behöver din hjälp.", "12 till 12", new OpeningTimes(LocalTime.of(9,00),LocalTime.of(10, 10),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00)),new ArrayList(Arrays.asList(new BlogPost("10.000 doser","Med hjälp av alla pengar vi har fått in, har vi nu lyckats skicka iväg ytterligare 10.000 vaccin till utsatta länder."),new BlogPost("Vi behöver pengar","Vi uppskattar alla donationer vi får i alla dess former, men just nu är det viktigaste att vi får in pengar för att på bästa sätt hjälpa folk i behov.")))),
