...
public class CompanyController {
    ...
    List<Company> getCompanies(){
        if(companyRepository.findAll().size()<6){
            companyRepository.saveAll(Arrays.asList(
                    new Company(null, "UNICEF", "Sankt Eriksgatan 46, 112 34 Stockholm","Stockholm", new Account(null,"Pernilla Baralt","123",Role.COMPANY), "UNICEF arbetar för alla barns rättigheter. Över hela världen kämpar vi för att alla barn ska få den barndom som de har rätt till. Men vi behöver din hjälp.", "12 till 12", new OpeningTimes(LocalTime.of(9,00),LocalTime.of(10, 10),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00))),
                    ...
                    new Company(null, "WWF", "Ulriksdals Slott, 170 81 Solna", "Solna",new Account(null,"Julia Volkova","123",Role.COMPANY), "WWF är en helt oberoende och partipolitiskt obunden miljö- och naturvårdsorganisation som bildades 1961.", "08.30 till 16.00", new OpeningTimes(LocalTime.of(9,00),LocalTime.of(10, 10),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00),LocalTime.of(10,00))),
    ...
    Company postCompany(@RequestBody Map<String, Object> companyForm){
        return companyRepository.save(new Company(null, (String) companyForm.get("cName"),(String) companyForm.get("cAddress"), ((String) companyForm.get("cCity")).trim(),accountRepository.findByUsername(((String) companyForm.get("cPerson"))),(String) companyForm.get("cDescription"),(String) companyForm.get("cHours"), new OpeningTimes()));
    }
